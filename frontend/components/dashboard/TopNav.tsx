...
export function TopNav({ onProfileClick }: TopNavProps) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-[32px] border border-blue-300 bg-gradient-to-r from-sky-100 to-blue-300 px-6 py-5 shadow-sm transition duration-300 sm:flex-row sm:items-center sm:justify-between">
      <div className="space-y-2">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <h1 className="bg-gradient-to-r from-sky-600 to-blue-800 bg-clip-text text-3xl py-2 font-extrabold text-transparent">Secure Data Exchange</h1>
        </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="relative">
          <button
            ...
            className="inline-flex items-center gap-3 rounded-3xl bg-blue-900 px-4 py-3 text-sm font-semibold text-white transition duration-200 hover:bg-blue-800"
          >
