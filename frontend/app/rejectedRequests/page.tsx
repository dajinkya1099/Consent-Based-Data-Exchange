      ...
      <div className="mx-auto max-w-[1440px] space-y-6">
        <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-semibold text-slate-900">Rejected Requests</h1>
              
            </div>

            <div className="flex w-full max-w-md items-center gap-3 rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3">
              <label htmlFor="rejected-search" className="sr-only">
        ...
        <section className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-sm">
          ...
          <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 text-sm text-slate-600">
            Showing {filteredRequests.length} rejected request{filteredRequests.length === 1 ? "" : "s"}.
          </div>
        </section>
      </div>
    </div>
